...
public final class VarStatement extends Statement
{
   ...
   *
   *  @param loc the source code location of the var statement.
   *  @param name the name of the identifier being declared.
   */
   ...
   *
   *  @param functionDepth the function depth of the identifier being declared.
   */
   ...
   *
   *  @param tempName the codegen temp name of the identifier being declared.
   */
   ...
   *
   *  @param type the type of the identifier being declared.
   */
